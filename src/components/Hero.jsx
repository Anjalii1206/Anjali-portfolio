...
const Hero = () => {
    ...
    <div className="mt-40 container mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <section className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="max-w-4xl text-left">
          ...
          transition={{ duration: 0.5, delay: 0 }}>Hi, my name is</motion.h1>
          <motion.h2 
  ...
  transition={{ duration: 0.6, ease: "easeOut", delay: 0.5 }} 
          >
            <a
              href="#contact"
              className="inline-block px-8 py-4 border border-purple-400 text-purple-400 rounded-lg text-lg transition-all duration-300 hover:text-green-400 hover:border-white"
            >
              Get In Touch
            </a>
            <a
              href="/assets/Anjali25.pdf"
              download="Anjali_Verma_Resume.pdf"
              className="inline-block px-8 py-4 border border-purple-400 text-purple-400 rounded-lg text-lg transition-all duration-300 hover:text-green-400 hover:border-white"
            >
              Resume
            </a>
  ...
  {[
    { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/anjali-verma-32b270224/", color: "hover:text-blue-600", xStart: -50 },
    { icon: <FaGithub />, link: "https://github.com/Anjalii1206", color: "hover:text-red-600", xStart: 50 },
    { icon: <SiLeetcode />, link: "https://leetcode.com/u/Anjali_1206/", color: "hover:text-yellow-400", xStart: -50 },
    { icon: <FaXTwitter />, link: "https://x.com/anjaliv1206", color: "hover:text-white", xStart: 50 },
  ].map((item, index) => (
    <motion.a
      key={index}
      href={item.link}
      ...
      whileHover={{ x: 5, scale: 1.50, rotate: 9 }} 
